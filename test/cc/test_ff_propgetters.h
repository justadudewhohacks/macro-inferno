...
public:
	...
	static NAN_METHOD(getAndReturnABoolRequired) {
		...
		FF_ARG_OBJ(0, FF_OBJ obj);
		FF_GET_BOOL_REQUIRED(obj, bool aBool, "aBool");
	...
	static NAN_METHOD(getAndReturnANumberRequired) {
		...
		FF_ARG_OBJ(0, FF_OBJ obj);
		FF_GET_NUMBER_REQUIRED(obj, double aNumber, "aNumber");
	...
	static NAN_METHOD(getAndReturnAnIntRequired) {
		...
		FF_ARG_OBJ(0, FF_OBJ obj);
		FF_GET_INT_REQUIRED(obj, int anInt, "anInt");
	...
	static NAN_METHOD(getAndReturnAnUintRequired) {
		...
		FF_ARG_OBJ(0, FF_OBJ obj);
		FF_GET_UINT_REQUIRED(obj, uint anUint, "anUint");
	...
	static NAN_METHOD(getAndReturnAStringRequired) {
		...
		FF_ARG_OBJ(0, FF_OBJ obj);
		FF_GET_STRING_REQUIRED(obj, std::string aString, "aString");
	...
	static NAN_METHOD(getAndReturnAnArrayRequired) {
		...
		FF_ARG_OBJ(0, FF_OBJ obj);
		FF_GET_ARRAY_REQUIRED(obj, FF_ARR anArray, "anArray");
		FF_RETURN(anArray);
	}
	...
	static NAN_METHOD(getAndReturnAnObjectRequired) {
		...
		FF_ARG_OBJ(0, FF_OBJ obj);
		FF_GET_OBJ_REQUIRED(obj, FF_OBJ anObject, "anObject");
		FF_RETURN(anObject);
	}
	...
	static NAN_METHOD(getAndReturnABoolOptional) {
		...
		FF_ARG_OBJ(0, FF_OBJ obj);
		FF_GET_BOOL_IFDEF(obj, bool aBool, "aBool", false);
		FF_RETURN(Nan::New(aBool));
	}
	...
	static NAN_METHOD(getAndReturnANumberOptional) {
		...
		FF_ARG_OBJ(0, FF_OBJ obj);
		FF_GET_NUMBER_IFDEF(obj, double aNumber, "aNumber", -0.1);
		FF_RETURN(Nan::New(aNumber));
	}
	...
	static NAN_METHOD(getAndReturnAnIntOptional) {
		...
		FF_ARG_OBJ(0, FF_OBJ obj);
		FF_GET_INT_IFDEF(obj, int anInt, "anInt", -2);
		FF_RETURN(Nan::New(anInt));
	}
	...
	static NAN_METHOD(getAndReturnAnUintOptional) {
		...
		FF_ARG_OBJ(0, FF_OBJ obj);
		FF_GET_UINT_IFDEF(obj, uint anUint, "anUint", 2);
		FF_RETURN(Nan::New(anUint));
	}
	...
	static NAN_METHOD(getAndReturnAStringOptional) {
		...
		FF_ARG_OBJ(0, FF_OBJ obj);
		FF_GET_STRING_IFDEF(obj, std::string aString, "aString", "foo");
		FF_RETURN(FF_NEW_STRING(aString));
	}
	...
	static NAN_METHOD(getAndReturnAnArrayOptional) {
		...
		FF_GET_ARRAY_IFDEF(obj, FF_ARR anArray, "anArray", defaultArr);
		FF_RETURN(anArray);
	}
	...
	static NAN_METHOD(getAndReturnAnObjectOptional) {
		...
		FF_GET_OBJ_IFDEF(obj, FF_OBJ anObject, "anObject", defaultObj);
		FF_RETURN(anObject);
	}
};